        ...
        <Card className="border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow cursor-pointer p-3 sm:p-4">
          <div className="flex flex-col sm:flex-row items-center sm:space-x-3 gap-1 sm:gap-0 text-center sm:text-left">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 hidden sm:block">Find new songs</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow cursor-pointer p-3 sm:p-4">
          <div className="flex flex-col sm:flex-row items-center sm:space-x-3 gap-1 sm:gap-0 text-center sm:text-left">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 hidden sm:block">Connect with users</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow cursor-pointer p-3 sm:p-4">
          <div className="flex flex-col sm:flex-row items-center sm:space-x-3 gap-1 sm:gap-0 text-center sm:text-left">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 hidden sm:block">Discover concerts</p>
            </div>
          </div>
        </Card>
      </div>
